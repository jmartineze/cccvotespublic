...
<div class="px-4 py-5 max-w-2xl mx-auto">
    <div class="mb-5">
        ...
        <h1 class="font-display text-xl font-800" style="color: var(--color-text);">New Contest</h1>
    </div>

    @include('partials.contest-form', ['contest' => null, 'action' => route('admin.contests.store'), 'method' => 'POST'])
</div>
@endsection
