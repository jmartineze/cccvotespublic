...
<div class="px-4 py-5 max-w-2xl mx-auto">
    <div class="flex items-center justify-between mb-5">
        <div>
            ...
            <h1 class="font-display text-xl font-800" style="color: var(--color-text);">Judges</h1>
        </div>
            ...
            <div class="card p-4" x-data="{ showReset: false }">
                ...
                <div class="flex gap-2 mt-3 pt-3" style="border-top: 1px solid var(--color-border);">
                    ...
                    <form method="POST" action="{{ route('admin.users.destroy', $judge) }}"
                          onsubmit="return confirm('Remove judge {{ addslashes($judge->name) }}? Their votes will also be deleted.')">
                        @csrf @method('DELETE')
